 ...
 * {@link classifier.FluoJImageProcessor}. User must label particles detected
 * with an {@link persistence.Type}, using legend provided on
 * {@link gui.CLegendJDialog}. Particles info is stored on
 * {@link classifier.SegmentedParticle}, including a default classification to
 * speed classification process. To persist {@link classifier.SegmentedParticle}
 * info "Save Measures" button is provided. "Edit" button invokes
 * {@link FluoJ_.Review_} plugin. Classifier training is done through "Train
 * Classifier" function, using information persisted for
...
public class TrainingJFrame extends FluoJJFrame {
    ...
    private void initSamplePane() {
        ...
        trainbt = new JButton("Train Classifier");
        samplepn.add(trainbt);
